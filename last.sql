...
--
-- Host: localhost:3306
-- Generation Time: Jul 22, 2021 at 09:59 AM
...
CREATE TABLE `checkin_mechanic` (
  ...
  `engine_no` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
(4, 4, '94797392', 'A38292-ajaj2938', '2021-07-22 03:19:00', 2, 'done', '2021-07-23');
...
(9, 'Pengecatan Body', 1000000, 4),
(10, 'Pesanganan Ban Dalam', 200000, 4);
...
CREATE TABLE `invoice` (
  ...
  `total claims` bigint NOT NULL,
  `pph` bigint NOT NULL,
  `admin_cost` bigint NOT NULL,
  `npwp` varchar(100) NOT NULL,
  `no_rek` varchar(100) NOT NULL,
  `bank` varchar(100) NOT NULL,
  `underpayment_customers` bigint NOT NULL,
...
CREATE TABLE `order_nasabah_customers` (
  ...
  `plate` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `request_services` (
  ...
  `file_genered` text,
  `actions` enum('pending apporved','apporved','pending','non approved','failed','in service','done') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(4, 'CA-TP002', '2021-07-22 02:10:44', '2021-07-22 02:19:24', 'bank mandiri-halima.pdf', 'apporved');
...
--
ALTER TABLE `checkin_mechanic`
  MODIFY `id_checkin_mechanic` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `estimasi`
  MODIFY `id_estimasi` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT for table `fee_service`
--
ALTER TABLE `fee_service`
  MODIFY `id_fee_service` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `request_services`
  MODIFY `id_request_service` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
